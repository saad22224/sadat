    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-6">
                <a href="{{ route('application.index') }}" class="text-blue-600 hover:underline">
                    تقديم الجامعات
                </a>
                ...
                <div class="-me-2 flex sm:hidden">
                    <button @click="open = ! open" class="p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none transition duration-150">
