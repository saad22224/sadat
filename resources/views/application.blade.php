    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
        ...
        <form action="{{ route('application.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="national_number" value="{{ old('national_number') }}"
            ...
            <div>
                ...
                <input type="text" name="high_school" value="{{ old('high_school') }}" class="w-full p-2 border rounded"
                    required>
            </div>

            <div>
                <label class="block font-medium">سنة التخرج</label>
                <input type="number" name="year_of_graduation" value="{{ old('year_of_graduation') }}"
                    class="w-full p-2 border rounded" required>
            </div>
            ...
            <div>
                ...
                <input type="file" name="high_school_certificate" class="w-full p-2 border rounded"
            ...
            <div class="text-center">
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">إرسال
                    الطلب</button>
            </div>
        </form>
    </div>
